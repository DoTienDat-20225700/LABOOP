...
public class CartScreenController {
	...
	@FXML
	private void removeButtonPressed(ActionEvent event) throws NonExistingItemException {
		Media media = tblMedia.getSelectionModel().getSelectedItem();
		this.cart.removeMedia(media);
		costLabel.setText(String.valueOf(this.cart.totalCost()));
	}
	@FXML
	private void playButtonPressed(ActionEvent event) throws PlayerException {
	...
	private void sortBtnPressed() {
		if (sortByTitle) {
			this.cart.sortByTitleThenCost();
		} else {
			this.cart.sortByCostThenTitle();
		}
	}
	@FXML
